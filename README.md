...
## 🛠️ Key Features
* **🖥️ User-Friendly GUI:** Simple interface to select folders with a built-in directory browser.
* **📂 Folder Organization:** Automatically moves sub-folders into the 'Others' directory to keep the root clean.
* **🛡️ Smart Error Handling:** Smoothly skips files that are locked or currently syncing (e.g., OneDrive syncing).
